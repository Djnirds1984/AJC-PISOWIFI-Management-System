...
void handleRoot() { server.send(200, "text/html", "<h1>PisoWiFi Setup</h1><p>Device is in Config Mode.</p>"); }
void handleWiFiScan() { server.send(200, "application/json", "{\"networks\":[]}"); }
void handleGetConfig() { server.send(200, "application/json", "{}"); }
