...
class EdgeSync {
  ...
  async registerOrFetchMachine() {
    ...
    try {
      ...
      // DEBUG: Introspect machines table
      try {
          console.log('[EdgeSync] Introspecting machines table...');
      ...
      */
      ...
      if (data) {
        ...
        const newMachinePayload = {
            ...
            // machine_name: `New Machine (${this.hardwareId.substring(0, 8)})`, // Column not in screenshot
            // status: 'online', // Column not in screenshot
            // total_revenue: 0 // Column not in screenshot
        };
