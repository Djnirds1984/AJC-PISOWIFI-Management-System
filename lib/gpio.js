...
function initGPIO(onPulse, boardType = 'none', pin = 2, boardModel = null, serialPort = '/dev/ttyUSB0', espIpAddress = '192.168.4.1', espPort = 80, coinSlots = []) {
...
function updateGPIO(boardType, pin, boardModel, serialPort, espIpAddress, espPort, coinSlots) {
  ...
  initGPIO(currentPulseCallback, boardType, pin, boardModel, serialPort, espIpAddress, espPort, coinSlots);
}
