    ...
    try {
      ...
      for (const line of arpLines) {
        ...
        if (match) {
          ...
          // Check if this interface is relevant (WiFi or Bridge)
          const isRelevantInterface = interfaces.some(i => 
            (i.name === ifaceName) && (i.type === 'wifi' || i.type === 'bridge')
          );
          
          if (isRelevantInterface) {
