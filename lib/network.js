...
async function autoProvisionNetwork() {
  ...
  try {
    ...
    await setupHotspot({ interface: bridgeName, ip_address: hotspotIP, dhcp_range: dhcpRange });
    ...
    if (wlanInterface) {
        ...
        await configureWifiAP({ interface: wlanInterface, ssid: finalSsid, password: finalPass, bridge: bridgeName });
    ...
    console.log('[NET] Auto-Provisioning Complete.');
  } catch (e) {
