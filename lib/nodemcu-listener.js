      ...
      try {
        ...
        if (!license.isValid) {
          ...
          return res.status(403).json({ 
            ...
            message: 'Your coinslot trial has expired or is invalid. Please contact the administrator.' 
          });
        }
        // ---------------------
        ...
        try {
          ...
          if (!license.isValid) {
            ...
            callback({ 
              ...
              message: 'Your coinslot trial has expired. Please contact the administrator.' 
            });
            return;
          }
          // ---------------------
        ...
        try {
          ...
          if (!license.isValid) {
            ...
            callback({ 
              success: false, 
              error: 'License expired', 
              message: 'Your coinslot trial has expired.' 
            });
            return;
          }
          // ---------------------
