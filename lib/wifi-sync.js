...
class WifiSync {
  ...
  async syncAllDevices() {
    ...
    try {
      ...
      for (const device of localDevices) {
        ...
        if (syncResult && syncResult.existingDevice && syncResult.existingDevice.machine_id !== this.machineId) {
  ...
  async syncDeviceToCloud(deviceData) {
    ...
    try {
      ...
      let result;
      let returnData = { existingDevice }; // Package existingDevice for return
